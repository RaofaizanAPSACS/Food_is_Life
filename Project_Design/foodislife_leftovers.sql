...
CREATE TABLE `leftovers` (
  ...
  CONSTRAINT `leftovers_ibfk_1` FOREIGN KEY (`item_id`, `restaurant_id`, `branch_id`) REFERENCES `food_items` (`id`, `restaurant_id`, `branch_id`)
...
INSERT INTO `leftovers` VALUES (30,'2024-05-13',1,2,2),(0,NULL,2,2,2),(0,NULL,3,2,2),(0,NULL,4,2,2);
